  ...
  return (
    <ReviewWrapper>
      ...
      <div className='RR-review-header'>
        ...
        <p>Date: {moment(Number(eachReview.date)).format('MMM Do YY')}</p>
        <p>
          Summary:
          {eachReview.summary}
        </p>
      ...
      <div className='RR-review-person-response'>
        ...
        {eachReview.response && (
          <p>
            ...
            {eachReview.response === 'null' ? 'No response' : eachReview.response}
          </p>
        )}
      </div>
      <div className='RR-helpful'>
        ...
        <label>{notHelpfulClick ? -1 : <HiThumbDown onClick={() => handleHelpful(false)} />}</label>
      </div>
      <br />
